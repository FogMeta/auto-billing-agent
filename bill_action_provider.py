        ...
        try:
            ...
            prompt = """Analyze the invoice content and extract key details. Transfer is strictly prohibited:
                ...
                Note: you should show the result of the following items under "Additional Information" part:
                       - Verify whether the current account matches the client account in the invoice. If they do not match, the transaction cannot proceed.
                       - Check whether the current account balance is sufficient for payment.
